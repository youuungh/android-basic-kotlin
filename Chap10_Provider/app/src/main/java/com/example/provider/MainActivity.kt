...
import com.example.provider.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonCamera.setOnClickListener {
            ...
            val photoURI: Uri= FileProvider.getUriForFile(this, "com.example.provider.file-provider", file)
    ...
    private fun calculateInSampleSize(fileUri: Uri, reqWidth: Int, reqHeight: Int): Int {
        ...
        try {
            ...
            로딩 하고자 하는 이미지의 각종 정보가 options에 설정됨 */
